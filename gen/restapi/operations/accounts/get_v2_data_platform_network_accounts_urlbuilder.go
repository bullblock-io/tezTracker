...
// GetV2DataPlatformNetworkAccountsURL generates an URL for the get v2 data platform network accounts operation
type GetV2DataPlatformNetworkAccountsURL struct {
	Network  string
	Platform string
...
func (o *GetV2DataPlatformNetworkAccountsURL) WithBasePath(bp string) *GetV2DataPlatformNetworkAccountsURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetV2DataPlatformNetworkAccountsURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetV2DataPlatformNetworkAccountsURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetV2DataPlatformNetworkAccountsURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetV2DataPlatformNetworkAccountsURL")
	}
...
func (o *GetV2DataPlatformNetworkAccountsURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetV2DataPlatformNetworkAccountsURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetV2DataPlatformNetworkAccountsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV2DataPlatformNetworkAccountsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV2DataPlatformNetworkAccountsURL")
	}
...
func (o *GetV2DataPlatformNetworkAccountsURL) StringFull(scheme, host string) string {
