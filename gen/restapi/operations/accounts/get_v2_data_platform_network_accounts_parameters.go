...
// NewGetV2DataPlatformNetworkAccountsParams creates a new GetV2DataPlatformNetworkAccountsParams object
// no default values defined in spec.
func NewGetV2DataPlatformNetworkAccountsParams() GetV2DataPlatformNetworkAccountsParams {

	return GetV2DataPlatformNetworkAccountsParams{}
}

// GetV2DataPlatformNetworkAccountsParams contains all the bound params for the get v2 data platform network accounts operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV2DataPlatformNetworkAccounts
type GetV2DataPlatformNetworkAccountsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV2DataPlatformNetworkAccountsParams() beforehand.
func (o *GetV2DataPlatformNetworkAccountsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindAccountDelegate(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindAccountManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindAPIKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindBlockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindBlockLevel(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindBlockNetid(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindBlockProtocol(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindOperationDestination(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindOperationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindOperationKind(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindOperationParticipant(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkAccountsParams) bindOperationSource(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkAccountsParams) bindSortBy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
