...
// NewGetV2DataPlatformNetworkBlocksParams creates a new GetV2DataPlatformNetworkBlocksParams object
// no default values defined in spec.
func NewGetV2DataPlatformNetworkBlocksParams() GetV2DataPlatformNetworkBlocksParams {

	return GetV2DataPlatformNetworkBlocksParams{}
}

// GetV2DataPlatformNetworkBlocksParams contains all the bound params for the get v2 data platform network blocks operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV2DataPlatformNetworkBlocks
type GetV2DataPlatformNetworkBlocksParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV2DataPlatformNetworkBlocksParams() beforehand.
func (o *GetV2DataPlatformNetworkBlocksParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindAccountDelegate(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindAccountManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindAPIKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindBlockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindBlockLevel(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindBlockNetid(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindBlockProtocol(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindOperationDestination(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindOperationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindOperationKind(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindOperationParticipant(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkBlocksParams) bindOperationSource(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkBlocksParams) bindSortBy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
