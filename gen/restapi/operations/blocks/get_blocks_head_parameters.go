...
// NewGetBlocksHeadParams creates a new GetBlocksHeadParams object
// no default values defined in spec.
func NewGetBlocksHeadParams() GetBlocksHeadParams {

	return GetBlocksHeadParams{}
}

// GetBlocksHeadParams contains all the bound params for the get blocks head operation
...
func (o *GetBlocksHeadParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetBlocksHeadParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
