...
func (o *GetBlockEndorsementsURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/blocks/{hash}/endorsements"

	hash := o.Hash
	if hash != "" {
		_path = strings.Replace(_path, "{hash}", hash, -1)
	} else {
		return nil, errors.New("hash is required on GetBlockEndorsementsURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetBlockEndorsementsURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetBlockEndorsementsURL")
	}
...
func (o *GetBlockEndorsementsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBlockEndorsementsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBlockEndorsementsURL")
	}
