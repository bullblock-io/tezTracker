...
func (o *GetBlocksListURL) Build() (*url.URL, error) {
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetBlocksListURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetBlocksListURL")
	}
...
func (o *GetBlocksListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBlocksListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBlocksListURL")
	}
