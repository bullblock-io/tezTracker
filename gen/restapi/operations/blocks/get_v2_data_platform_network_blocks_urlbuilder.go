...
// GetV2DataPlatformNetworkBlocksURL generates an URL for the get v2 data platform network blocks operation
type GetV2DataPlatformNetworkBlocksURL struct {
	Network  string
	Platform string
...
func (o *GetV2DataPlatformNetworkBlocksURL) WithBasePath(bp string) *GetV2DataPlatformNetworkBlocksURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetV2DataPlatformNetworkBlocksURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetV2DataPlatformNetworkBlocksURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/v2/data/{platform}/{network}/blocks"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetV2DataPlatformNetworkBlocksURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetV2DataPlatformNetworkBlocksURL")
	}
...
func (o *GetV2DataPlatformNetworkBlocksURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetV2DataPlatformNetworkBlocksURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetV2DataPlatformNetworkBlocksURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV2DataPlatformNetworkBlocksURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV2DataPlatformNetworkBlocksURL")
	}
...
func (o *GetV2DataPlatformNetworkBlocksURL) StringFull(scheme, host string) string {
