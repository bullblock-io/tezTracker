...
// NewGetV2DataPlatformNetworkOperationsParams creates a new GetV2DataPlatformNetworkOperationsParams object
// no default values defined in spec.
func NewGetV2DataPlatformNetworkOperationsParams() GetV2DataPlatformNetworkOperationsParams {

	return GetV2DataPlatformNetworkOperationsParams{}
}

// GetV2DataPlatformNetworkOperationsParams contains all the bound params for the get v2 data platform network operations operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV2DataPlatformNetworkOperations
type GetV2DataPlatformNetworkOperationsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV2DataPlatformNetworkOperationsParams() beforehand.
func (o *GetV2DataPlatformNetworkOperationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindAccountDelegate(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindAccountManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindAPIKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindBlockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindBlockLevel(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindBlockNetid(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindBlockProtocol(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindOperationDestination(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindOperationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindOperationKind(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindOperationParticipant(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsParams) bindOperationSource(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsParams) bindSortBy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
