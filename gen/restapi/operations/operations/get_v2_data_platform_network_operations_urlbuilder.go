...
// GetV2DataPlatformNetworkOperationsURL generates an URL for the get v2 data platform network operations operation
type GetV2DataPlatformNetworkOperationsURL struct {
	Network  string
	Platform string
...
func (o *GetV2DataPlatformNetworkOperationsURL) WithBasePath(bp string) *GetV2DataPlatformNetworkOperationsURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetV2DataPlatformNetworkOperationsURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetV2DataPlatformNetworkOperationsURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetV2DataPlatformNetworkOperationsURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetV2DataPlatformNetworkOperationsURL")
	}
...
func (o *GetV2DataPlatformNetworkOperationsURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetV2DataPlatformNetworkOperationsURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetV2DataPlatformNetworkOperationsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV2DataPlatformNetworkOperationsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV2DataPlatformNetworkOperationsURL")
	}
...
func (o *GetV2DataPlatformNetworkOperationsURL) StringFull(scheme, host string) string {
