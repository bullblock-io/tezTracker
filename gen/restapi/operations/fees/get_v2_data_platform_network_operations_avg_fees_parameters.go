...
// NewGetV2DataPlatformNetworkOperationsAvgFeesParams creates a new GetV2DataPlatformNetworkOperationsAvgFeesParams object
// no default values defined in spec.
func NewGetV2DataPlatformNetworkOperationsAvgFeesParams() GetV2DataPlatformNetworkOperationsAvgFeesParams {

	return GetV2DataPlatformNetworkOperationsAvgFeesParams{}
}

// GetV2DataPlatformNetworkOperationsAvgFeesParams contains all the bound params for the get v2 data platform network operations avg fees operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV2DataPlatformNetworkOperationsAvgFees
type GetV2DataPlatformNetworkOperationsAvgFeesParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV2DataPlatformNetworkOperationsAvgFeesParams() beforehand.
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindAccountDelegate(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindAccountManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindAPIKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindBlockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindBlockLevel(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindBlockNetid(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindBlockProtocol(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOperationDestination(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOperationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOperationKind(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOperationParticipant(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOperationSource(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesParams) bindSortBy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
