...
// GetV2DataPlatformNetworkOperationsAvgFeesURL generates an URL for the get v2 data platform network operations avg fees operation
type GetV2DataPlatformNetworkOperationsAvgFeesURL struct {
	Network  string
	Platform string
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) WithBasePath(bp string) *GetV2DataPlatformNetworkOperationsAvgFeesURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/v2/data/{platform}/{network}/operations/avgFees"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetV2DataPlatformNetworkOperationsAvgFeesURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetV2DataPlatformNetworkOperationsAvgFeesURL")
	}
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV2DataPlatformNetworkOperationsAvgFeesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV2DataPlatformNetworkOperationsAvgFeesURL")
	}
...
func (o *GetV2DataPlatformNetworkOperationsAvgFeesURL) StringFull(scheme, host string) string {
