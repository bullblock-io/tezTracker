...
func (o *GetAvgFeesURL) Build() (*url.URL, error) {
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAvgFeesURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAvgFeesURL")
	}
...
func (o *GetAvgFeesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAvgFeesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAvgFeesURL")
	}
