...
// NewGetV2DataPlatformNetworkOperationGroupsParams creates a new GetV2DataPlatformNetworkOperationGroupsParams object
// no default values defined in spec.
func NewGetV2DataPlatformNetworkOperationGroupsParams() GetV2DataPlatformNetworkOperationGroupsParams {

	return GetV2DataPlatformNetworkOperationGroupsParams{}
}

// GetV2DataPlatformNetworkOperationGroupsParams contains all the bound params for the get v2 data platform network operation groups operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV2DataPlatformNetworkOperationGroups
type GetV2DataPlatformNetworkOperationGroupsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV2DataPlatformNetworkOperationGroupsParams() beforehand.
func (o *GetV2DataPlatformNetworkOperationGroupsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindAccountDelegate(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindAccountManager(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindAPIKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindBlockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindBlockLevel(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindBlockNetid(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindBlockProtocol(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOperationDestination(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOperationID(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOperationKind(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOperationParticipant(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOperationSource(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindOrder(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV2DataPlatformNetworkOperationGroupsParams) bindSortBy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
